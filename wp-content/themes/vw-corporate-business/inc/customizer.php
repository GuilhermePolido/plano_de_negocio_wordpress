...
function vw_corporate_business_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_corporate_business_slider_hide_show',array(
	       'default' => 'false',
	       'sanitize_callback'	=> 'sanitize_text_field'
	));

	$wp_customize->add_control('vw_corporate_business_slider_hide_show',array(
	   'type' => 'checkbox',
	   'label' => __('Show / Hide slider','vw-corporate-business'),
